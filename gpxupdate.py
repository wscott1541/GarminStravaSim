...
def parse_arguments(argv):
    ...
    #WS
    activities_directory = './GPXarchive.gitignore'
...
users = pd.DataFrame(user_data, columns= ['Username','Password'])

usernames = users['Username'].tolist()
passwords = users['Password'].tolist()
GSS_username = usernames[0]
GSS_password = passwords[0]
